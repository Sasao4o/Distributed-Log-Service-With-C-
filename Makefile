...
compileSegmentTest:
	g++ -o ./build/segment/segment_test ./test/segment/segment_test.cpp ./api/v1/logprog.pb.cc ./src/disk/File.cpp ./src/segment/segment.cpp ./src/index/index.cpp ./src/store/store.cpp -lprotobuf -pthread
